...
# We are testing the exact logic used in database_export and bulk_import
...
# We use using('default') because that's what database_export / bulk_import does implicitly
