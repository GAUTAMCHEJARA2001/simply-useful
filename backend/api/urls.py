...
from api.views import (
    ...
    transaction_dispatch_log_detail,
    transaction_production_materials, fix_old_productions, transaction_adjustments, transaction_adjustments_detail,
...
from api.views_hr import (
    ...
    hr_attendance, hr_generate_payroll, hr_finalize_payroll, hr_mark_slip_paid, hr_employee_ledger, hr_import_employees, hr_employee_change_status,
...
from api.leave_views import hr_leave_policies, hr_leave_policies_detail, hr_leave_allocate, hr_leave_auto_fetch, hr_leave_records_detail
...
urlpatterns = [
    ...
    path('transactions/dispatch-logs/<str:pk>', transaction_dispatch_log_detail, name='tx-dispatch-log-detail'),
    ...
    path('hr/employees/<str:pk>/change-status', hr_employee_change_status, name='hr-employee-change-status'),
    ...
    path('hr/leave-records/<str:pk>', hr_leave_records_detail, name='hr-leave-records-detail'),
