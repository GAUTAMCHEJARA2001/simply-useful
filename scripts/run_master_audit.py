...
# Ensure backend directory is in Python path when executed from root folder
...
try:
    ...
    from backend.api.models import Company, User, Product, Category, Warehouse, Dealer, Supplier, Order, Orderitem, Stocktransaction
...
def run_all_checks():
    ...
    try:
        call_command('test', 'api', 'core', verbosity=1)
